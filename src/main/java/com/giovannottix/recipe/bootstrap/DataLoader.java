...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addIngredient(new Ingredient("fresh lime juice or lemon " +
                "juice", new BigDecimal(2), tableSpoonUom, guacRecipe));
        ...
        guacRecipe.addIngredient(new Ingredient("ripe tomato, seeds and pulp " +
                "removed, chopped", new BigDecimal(".5"), eachUom, guacRecipe));
        ...
        tacosRecipe.addIngredient(new Ingredient("fresh-squeezed orange " +
                "juice", new BigDecimal(3), tableSpoonUom, tacosRecipe));
        ...
        tacosRecipe.addIngredient(new Ingredient("cup sour cream thinned with" +
                " 1/4 cup milk", new BigDecimal(4), cupsUom, tacosRecipe));
